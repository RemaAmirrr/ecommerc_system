...
function PaymentSuccess() {
  ...
  useEffect(() => {
    ...
    apiInstance.post(`payment-success/${order.oid}/`, formdata).then((res) => {
      ...
      if (res.data.message === "Your Invoice id Unpaid"){
         setStatus("Your Invice is Unpaid")
       }       
    })
  }, [param?.order_oid])
      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          <div className="modal-body text-start text-black p-4">
            ...
            <h6>{order.email}</h6>
            <h6 className="mb-5">{order.mobile}</h6>
            ...
            <div className="d-flex justify-content-between">
              ...
              <p className="small mb-0">-${order.total}</p>
            </div>
