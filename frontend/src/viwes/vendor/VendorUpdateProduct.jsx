...
const handleImageChange = (index, event, setSteateFunction) => {
 const file = event.target.files[0]
 if(file) {
     const reader = new FileReader()

     reader.onloadend = () => {
         setSteateFunction((prevState) => {
             const newState = [...prevState]
...
const handleSubmit = async (e) =>{
  ...
  const response = await apiInstance.patchForm(`vendor-update-product/${userData?.vendor_id}/${param.pid}/`, formdata,{
    headers: {
                      ...
                      <div className="card-body">                   
                          <div className="row text-dark">
                            <div className="col-lg-6 mb-2">
                              ...
                              />
                               {/* <img style={{width:"100%", height: "200px", objectFit:"cover", borderRadius:"10px"}} 
                                  src={product.image} 
                                  alt=""/> */}
                            </div>
                            <div className="col-lg-6 mb-2 ">
                         ...
                         {gallery?.map((item, index) => (
                             ...
                             <div className="col-lg-6 mb-2">
                              {item.image && (item.image.preview ? (
                                  ...
                                  {!item.image &&(
                                    <img style={{width:"100%", height: "200px", objectFit:"cover", borderRadius:"10px"}} 
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgJw-vxpsQbYZhmNYZeSeloIFhLEzclHkBug&s"
                                    alt=""
                                    />
                                  )}
                             </div>
                        ...
                        <div className="row text-dark">
                          {specifications?.map((specification, index) => (
                                ...
                                <div className="col-lg-5 mb-5">
                                    ...
                                    <input value={specification.content || ''} type="text" onChange={(e) => handleInputChange(index, 'content', e.target.value, setSpecifications)} className="form-control"/>
                                </div>
                                <div className='col-lg-2 mt-4' >
                                  <button onClick={() => handleRemove(index, setSpecifications)} type="button" className='btn btn-danger'>Remove</button>
                                </div> 
                                </div>
                    ...
                    <div className="card mb-3">
                      <div className="card-body">
                        {sizes.map?.((s, index) => (
                            ...
                            <div className="col-lg-2 mt-4">
                                <button onClick={() => handleRemove(index, setSizes)} type="button" className='btn btn-danger'>Remove</button>
                            </div>
                            </div>
                          </div>
                    ...
                    <div className="card mb-3">
                      <div className="card-body">
                          {colors?.map((c, index) => (
                            ...
                            <div className="col-lg-5 ">
                              <label htmlFor="" className=""> Name</label>
                              <input  value={c.name || ''} onChange={(e) => handleInputChange(index, 'name', e.target.value, setColors)}type="text" className="form-control" />
                            </div>
                            <div className="col-lg-5 ">
                              <label htmlFor="" className=""> Price </label>
                              <input   value={c.price || ''}onChange={(e) => handleInputChange(index, 'price', e.target.value, setColors)}type="number"  className="form-control" />
                            </div>
                            <div className="col-lg-2 ">
                            <div className="col-lg-2 mt-4 ">
                                  <button onClick={() => handleRemove(index, setColors)}type="button" className='btn btn-danger'>Remove</button>
                              </div>
                            </div>
                            </div>
                        ))}
                        {colors < 1 && 
                          <h5>Colors Not Selected </h5>
                        }
