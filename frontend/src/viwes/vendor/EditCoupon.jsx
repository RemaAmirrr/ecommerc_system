...
function EditCoupon() {
    ...
    const handleUpdateCoupon = (e) => {
        ...
        apiInstance.patch(`vendor-coupon-detail/${UserData()?.vendor_id}/${param.coupon_id}/`, formdata).then((res) =>{
        ...
        <div className="col-md-9 col-lg-10 main mt-4">
            ...
            <form onSubmit={handleUpdateCoupon} className='card shadow p-3'>
                ...
                <div className="mb-3 form-check">
                    <input checked={coupon.active} name="active" onChange={handleChangeCoupon} type="checkbox" className="form-check-input" id="exampleCheck1" />
