...
function VendorDashboard() {
  ...
  useEffect(() =>{
    apiInstance.get(`vendor/state/${UserData()?.vendor_id}/`).then((res) => {
      setstate(res.data[0])
    })
        ...
        <div className="col-xl-3 col-lg-6 mb-2">
          <div className="card card-inverse card-success">
            <div className="card-block bg-success p-3">
              ...
              <h1 className="display-1">{state?.products}</h1>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-lg-6 mb-2">
          <div className="card card-inverse card-danger">
            <div className="card-block bg-danger p-3">
              ...
              <h1 className="display-1">{order_counts}</h1>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-lg-6 mb-2">
        ...
        <div className="col-xl-3 col-lg-6 mb-2">
          <div className="card card-inverse card-warning">
            <div className="card-block bg-warning p-3">
              ...
              <h1 className="display-1">{state.revenue}</h1>
            </div>
          </div>
        </div>
      </div>
