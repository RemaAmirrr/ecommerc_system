...
function OrderDetaill() {

  const [order, setOrder] = useState({})
  const [orderItem, setOrderItem] = useState([]) 
  // this is very impotant take a lot of time for order in here put {} and for orderItem []
  ...
  try{
    await apiInstance.get(`customer/order_detail/${param.order_oid}`).then((res) => {
       setOrder(res.data)
