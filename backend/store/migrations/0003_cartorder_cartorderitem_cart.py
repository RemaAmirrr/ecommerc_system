# Generated by Django 4.2.7 on 2024-12-23 18:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_totle', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ...
                ('payment_status', models.CharField(choices=[('paidt', 'Paid'), ('pending', 'Pending'), ('processing', 'Processing'), ('cancelled', 'Cancelled')], default='pending', max_length=100)),
                ('order_status', models.CharField(choices=[('paidt', 'Paid'), ('pending', 'Pending'), ('processing', 'Processing'), ('cancelled', 'Cancelled')], default='pending', max_length=100)),
                ...
                ('full_neme', models.CharField(blank=True, max_length=100, null=True)),
